      ...
      if (data.success && data.data) {
        ...
        const processedBanners = data.data.map(page => {
          ...
          const bannerData = {
            ...
            images: (page.images && page.images.length > 0) ? page.images : (page.image ? [page.image] : []),
            allImages: (page.images && page.images.length > 0) ? page.images : (page.image ? [page.image] : [])
          };
    ...
    try {
      ...
      if (data.success && data.data) {
        ...
        const bannerData = {
          ...
          pageType: page.pageType || 'custom',
          createdAt: page.createdAt || new Date().toISOString(),
          images: page.images || (page.image ? [page.image] : []),
          allImages: page.allImages || (page.image ? [page.image] : [])
        };
...
export const selectPageBanners = (state) => state.banner.pageBanners;
